...
function bindInputs(){
  ...
  document.addEventListener("click",e=>{
    ...
    if(s){
      ...
      if(i.dataset.type==="md")i.closest(".question").querySelector('[data-type="d"]').focus();
      return;
    }
